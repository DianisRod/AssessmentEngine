// Dieses skript beinhaltet einiges an uebernommener Layout-Funktionalitaet

var currentTab = 0; // Current tab is set to be the first tab (0)

// Dieses json Objekt soll zugkuenftig vom Server hierhin mittels template gesetzt werden bzw mittels request besorgt werden.
var questions = {
	"name": "Assessment 1",
	"Fragen":
		[
			{
				"Fragetext": "Wie geht es Ihnen?",
				"Beschreibung": "",
				"Typ": "freifeld"
			},
			{
				"Fragetext": "In welchem Kontinent liegt Kolumbien?",
				"Beschreibung": "",
				"Typ": "singlechoice",
				"Antworten": [{"val": "Afrika"}, {"val": "Europa"}, {"val": "Amerika"}] 
			},	
			{
				"Fragetext": "Nennen Sie 2 Städte in Deutschland?",
				"Beschreibung": "",
				"Typ": "Multichoice",
				"Antworten": [{"val": "Bogota"}, {"val": "Berlin"}, {"val": "Hamburg"}] 
			}
		]
}
...
function showTab(n) {
  ...
  // Ein 'Zurueck'-Button ist hier nicht gefordert
...
function showResults(form){
	...
	var solutions = 'Ihre Lösungen werden übermittelt:<br>'
	...
	output.push('<a href="index.html">Zurück zur Startseite</a>');
	output.push('</div>');
	
	contentContainer.innerHTML = output.join('');
}

// uebernommene Layout-Funktionalitaet
